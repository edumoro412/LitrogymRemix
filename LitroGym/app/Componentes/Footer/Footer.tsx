...
export default function Footer() {
  return (
    <footer className="mt-8 py-4 bg-gray-900 text-white flex flex-col md:flex-row items-center md:items-start justify-between px-8 md:px-16 h-auto md:h-[30vh]">
